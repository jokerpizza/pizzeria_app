...
# register realtime costs blueprint
...
# ---- realtime costs blueprint ----
from pizzeria_app.blueprints.realtime_costs import costs_rt_bp
app.register_blueprint(costs_rt_bp, url_prefix='/rt_costs')
