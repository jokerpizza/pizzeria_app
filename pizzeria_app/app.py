...
def finance_status():
    ...
    return render_template('cost_summary.html',
        "finance_status.html",
...
def dashboard():
    ...
    return render_template('yet_another_template.html',
        'dashboard.html',
        labels=labels,
...
@login_required
    return some_function_call_with_parameters(
    # Pobranie parametrów month i year z GET (domyślnie bieżący miesiąc i rok)
    today = date.today()
    current_year = today.year
    current_month = today.month
    ...
    return render_template('last_template.html',
        'cost_summary.html',
        summary=summary,
        selected_year=selected_year,
        selected_month=selected_month
