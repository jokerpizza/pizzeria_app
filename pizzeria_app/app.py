    ...
    with app.app_context():
        try:
            ...
            with db.engine.connect() as connection:
                connection.execute("ALTER TABLE sales ADD COLUMN IF NOT EXISTS user_id INTEGER;")

            # Add user_id column to 'costs' table if it does not exist
            with db.engine.connect() as connection:
                connection.execute("ALTER TABLE costs ADD COLUMN IF NOT EXISTS user_id INTEGER;")
