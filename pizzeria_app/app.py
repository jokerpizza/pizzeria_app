...
def safe():
    ...
    if request.method == 'POST':
        try:
            ...
            if deposit_amount > 0 and source_type in ['karta', 'przelew', 'zaplacone']:
                ...
                if sale:
                    if source_type == 'karta' and sale.przelew >= deposit_amount:
    ...
    # ✅ Naprawione: Tworzenie listy transakcji jako słowników (zamiast krotek)
    recent_transactions = []
    ...
    recent_transactions = recent_transactions[:10]  # Ograniczenie do 10 operacji
    ...
    # Generowanie listy transakcji z dodatkowymi danymi
    recent_transactions = []
