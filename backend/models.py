...
class Recipe(db.Model):
    ...
    def to_dict(self):
        ...
        return {
            ...
            'price_dine_in': self.price_dine_in,'price_delivery': self.price_delivery,
            'trade_names': self.trade_names.split(',') if self.trade_names else [],
            'ingredients':[ri.to_dict() for ri in self.ingredients],
            'food_cost_dine_in_pct': fc_dine,'food_cost_delivery_pct': fc_del,
            'margin_pln_dine': margin_pln_dine,'margin_pln_delivery': margin_pln_del,
            'margin_pct_dine': margin_pct_dine,'margin_pct_delivery': margin_pct_del,
...
class RecipeIngredient(db.Model):
    ...
    def to_dict(self):
        return {'id': self.id,'ingredient': self.ingredient.to_dict(),'quantity': self.quantity}